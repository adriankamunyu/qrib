  ...
  const handleSubmit = (e) => {
    ...
    showToast(
      mode === "login"
        ...
        : "Account created — welcome to Qrib!",
      "success"
    );

    if (mode === "signup" && role === "host") {
      navigate("/host");
    } else {
      navigate("/");
    }
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-20 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-6 max-w-xl">
          ...
          <p className="text-lg text-slate-200 leading-relaxed">
            Connect with verified hosts, find apartments close to your
            Kenyan university, and book safely with student discounts.
          </p>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8 sm:p-20">
        <div className="w-full max-w-[440px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            <h2 className="font-extrabold text-3xl text-slate-900">
              {mode === "login"
                ? "Welcome back"
                : "Create your account"}
            </h2>
          ...
          <button
            ...
            onClick={() =>
              showToast(
                "Google sign-in isn't wired to a real backend in this demo.",
                "info"
              )
            }
            className="border border-slate-200 bg-white flex items-center justify-center gap-3 p-3.5 rounded-lg font-semibold text-slate-900 hover:bg-slate-50 transition"
          >
            <svg
              width="18"
              height="18"
          ...
          >
            ...
            {mode === "signup" && (
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="border border-slate-200 rounded-lg p-3.5 text-[15px] text-slate-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500"
                />
              </div>
            )}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="border border-slate-200 rounded-lg p-3.5 flex items-center gap-2 bg-white focus-within:ring-2 focus-within:ring-blue-500/40 focus-within:border-blue-500">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  className="flex-1 outline-none text-[15px] text-slate-900 bg-transparent"
                />
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white p-4 rounded-lg font-bold text-base shadow-md transition"
            >
              {mode === "login"
                ? "Log In"
                : "Create Account"}
          ...
          {mode === "login" && (
            <div className="rounded-lg bg-slate-50 border border-slate-200 p-4">
              <p className="text-xs text-slate-500 leading-relaxed">
                ...
                <br />
                Student: student@university.ac.ke
                <br />
                Host: host@qrib.co.ke
                <br />
